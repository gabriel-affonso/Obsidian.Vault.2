...
const transacoes = [
    ...
    { item: "Jogos Switch", valor: -55, moeda: 'BRL', tipo: 'Gasto' },
    { item: "Naruto Switch", valor: -10, moeda: 'EUR', tipo: 'Gasto' },
    { item: "Mercado Bel", valor: -12, moeda: 'EUR', tipo: 'Gasto' },
    { item: "Mercado da Semana 5", valor: -10, moeda: 'EUR', tipo: 'Gasto' },
     { item: "Relógio ihih", valor: -84, moeda: 'EUR', tipo: 'Gasto' },
     { item: "ADA Revolut", valor: -16, moeda: 'EUR', tipo: 'Investimento' },
     { item: "Shoppingizinho com a bel", valor: -26, moeda: 'EUR', tipo: 'Investimento' },
];
